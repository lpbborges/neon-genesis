...
function M.load()
	...
	h("Boolean", { fg = colors.purple, bold = true })
	...
	h("@string.special", { fg = colors.blue, bold = true })
	h("@string.regex", { fg = colors.yellow })
	h("@number", { fg = colors.blue })
	h("@boolean", { fg = colors.purple, bold = true })
	h("@type", { fg = colors.yellow })
	h("@type.builtin", { fg = colors.yellow, italic = true })
	...
	h("@constructor", { fg = colors.yellow })
